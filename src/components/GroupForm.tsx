...
const GroupForm = () => {
  ...
  (createChatGroupMutation.isSuccess || updateChatGroupMutation.isSuccess) &&
    ...
    <div className='pt-4 px-2'>
      ...
      >
        ...
        <label className='flex flex-col gap-6'>
          <span className='font-semibold'>Add a Member by Email</span>
          <input
            type='email'
            ref={emailInputRef}
          ...
          useGetUserEmailMutation.data.length > 0 ? (
            <div className='max-h-40 rounded-lg  overflow-y-auto shadow'>
        ...
        {groupChat && (
          <button
            type='button'
            className='text-red p-2 font-semibold'
            onClick={() => {
              setMembers([]);
              setAdmins([]);
              setFile(null);
