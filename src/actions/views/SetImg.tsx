      ...
      <div className='flex flex-col justify-center items-center relative w-200 h-3/4 bg-grayLight rounded-3xl animate-mtl'>
        ...
        >
          ...
          <div className='relative mb-10'>
            <div className='flex justify-center items-center w-60 h-60 bg-grayReg border-2 border-dashed rounded-full hover:cursor-pointer'>
              <svg
                className='w-32 h-36'
                viewBox='0 0 18 20'
                fill='none'
            ...
            <div className='absolute flex w-12 h-12 bg-brightPurple rounded-full bottom-3 right-3 text-white items-center justify-center text-4xl leading-none transition hover:bg-darkPurple hover:scale-110 hover:cursor-pointer'>
              &#43;
            </div>
          </div>
