...
const Cover: React.FC = () => {
  return (
    <div className='w-full h-full flex flex-col justify-center items-center'>
      ...
      <h2 className='text-grayReg text-5xl mb-10 capitalize'>chat app web</h2>
      <p className='text-grayReg text-xl w-100 text-center'>
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Odit culpa et
        odio deserunt deleniti quisquam illum esse. Provident fugit dolorem
      </p>
    </div>
  );
};
